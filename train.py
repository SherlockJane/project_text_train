...
tf.flags.DEFINE_string("positive_data_file", "./fenci/train_positive.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./fenci/train_negative.txt", "Data source for the negative data.")
